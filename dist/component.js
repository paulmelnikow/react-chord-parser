(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['module', "./raphael.chord.js/raphael.chord"], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, require("./raphael.chord.js/raphael.chord"));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, global.raphael);
        global.component = mod.exports;
    }
})(this, function (module, Raphael) {
    'use strict';

    (function (name, context, definition) {
        if (typeof module !== 'undefined' && module.exports) module.exports = definition();else if (typeof define === 'function' && define.amd) define(definition);else context[name] = definition();
    })('ChordParserRender', undefined, function () {
        'use strict';
        ...
        ChordParser.prototype.renderUnique = function (parent, supplier) {
        ...
        var removeBraces = function removeBraces(chord) {
