(function (global, factory) {
    ...
    Chord.prototype = {
        init: function init(name, positions, fingers) {
        ...
        parse: function parse(frets, fingers) {
            this.positions = [];
            var raw = [];
        ...
        drawMutedAndOpenStrings: function drawMutedAndOpenStrings(info) {
            var r = this.renderer;
        ...
        drawPositions: function drawPositions(info) {
            var r = this.renderer;
            for (var i in this.positions) {
                var pos = this.positions[i];
                if (pos > 0) {
        ...
        drawFretGrid: function drawFretGrid(info) {
            var r = this.renderer;
        ...
        drawName: function drawName(info) {
            var r = this.renderer;
        ...
        calculateDimensions: function calculateDimensions(scale) {
            var info = {};
            scale--;
        ...
        getDiagram: function getDiagram(scale, renderer) {
        ...
        drawBars: function drawBars(info) {
            var r = this.renderer;
        ...
        drawCross: function drawCross(info, x, y, radius, lineWidth) {
            var r = this.renderer;
            var angle = Math.PI / 4;
            for (var i = 0; i < 2; i++) {
        ...
        drawFingerings: function drawFingerings(info) {
            var r = this.renderer;
